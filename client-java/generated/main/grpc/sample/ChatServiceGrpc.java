...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<sample.ChatOuterClass.PostRequest,
      com.google.protobuf.Empty> getPostMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Post",
      requestType = sample.ChatOuterClass.PostRequest.class,
      responseType = com.google.protobuf.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sample.ChatOuterClass.PostRequest,
      com.google.protobuf.Empty> getPostMethod() {
    io.grpc.MethodDescriptor<sample.ChatOuterClass.PostRequest, com.google.protobuf.Empty> getPostMethod;
    if ((getPostMethod = ChatServiceGrpc.getPostMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getPostMethod = ChatServiceGrpc.getPostMethod) == null) {
          ChatServiceGrpc.getPostMethod = getPostMethod =
              io.grpc.MethodDescriptor.<sample.ChatOuterClass.PostRequest, com.google.protobuf.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Post"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sample.ChatOuterClass.PostRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      sample.ChatOuterClass.GetResponse> getGetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Get",
      requestType = com.google.protobuf.Empty.class,
      responseType = sample.ChatOuterClass.GetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      sample.ChatOuterClass.GetResponse> getGetMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, sample.ChatOuterClass.GetResponse> getGetMethod;
    if ((getGetMethod = ChatServiceGrpc.getGetMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getGetMethod = ChatServiceGrpc.getGetMethod) == null) {
          ChatServiceGrpc.getGetMethod = getGetMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, sample.ChatOuterClass.GetResponse>newBuilder()
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protobuf.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sample.ChatOuterClass.GetResponse.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void post(sample.ChatOuterClass.PostRequest request,
    ...
    public void get(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<sample.ChatOuterClass.GetResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                sample.ChatOuterClass.PostRequest,
          ...
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.google.protobuf.Empty,
                sample.ChatOuterClass.GetResponse>(
                  this, METHODID_GET)))
          .build();
    }
  }
  ...
  public static final class ChatServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<ChatServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.Empty post(sample.ChatOuterClass.PostRequest request) {
    ...
    /**
     */
    public java.util.Iterator<sample.ChatOuterClass.GetResponse> get(
  ...
  public static final class ChatServiceFutureStub extends io.grpc.stub.AbstractFutureStub<ChatServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty> post(
        sample.ChatOuterClass.PostRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_POST:
          serviceImpl.post((sample.ChatOuterClass.PostRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_GET:
  ...
  private static abstract class ChatServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sample.ChatOuterClass.getDescriptor();
    }
